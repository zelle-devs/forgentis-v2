...
function LoadingScreen({ onComplete, skipAnimation = false }) {
  ...
  useEffect(() => {
    // Agar animation is session mein pehle hi dikh chuki hai, to poori GSAP
    // timeline chalane ke bajaye seedha turant complete kar do — koi jhatka
    // ya delay nahi, bilkul instant.
    if (skipAnimation) {
